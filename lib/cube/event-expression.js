  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        ...
        "event_alternative_member_expression": parse_event_alternative_member_expression,
      ...
      function parse_event_filter_expression() {
        ...
        var savedPos2 = pos;
        var savedPos3 = pos;
        var result14 = parse_filter_operator();
        if (result14 !== null) {
          ...
          if (result15 !== null) {
            ...
            if (result16 !== null) {
              ...
              if (result17 !== null) {
                var result18 = parse_event_alternative_member_expression();
                if (result18 !== null) {
                      ...
                      if (result21 !== null) {
                        ...
                        if (result22 !== null) {
                          ...
                          if (result23 !== null) {
                            ...
                            if (result24 !== null) {
                              var result12 = [result14, result15, result16, result17, result18, result19, result20, result21, result22, result23, result24];
                            } else {
                              var result12 = null;
                              pos = savedPos3;
                            }
        ...
        var result13 = result12 !== null
          ? (function(op, member, value) { return function(o) { op(o, member.field, value); }; })(result12[0], result12[4], result12[8])
          : null;
        if (result13 !== null) {
        ...
        if (result11 !== null) {
          ...
          var savedPos0 = pos;
          var savedPos1 = pos;
          var result4 = parse_filter_operator();
          if (result4 !== null) {
            var result5 = parse__();
            if (result5 !== null) {
              if (input.substr(pos, 1) === "(") {
              ...
              if (result6 !== null) {
                var result7 = parse__();
                if (result7 !== null) {
                  var result8 = parse_event_alternative_member_expression();
                  if (result8 !== null) {
                    var result9 = parse__();
                    if (result9 !== null) {
                      if (input.substr(pos, 1) === ")") {
          ...
          var result3 = result2 !== null
            ? (function(op, member) { return function(o) { op(o, member.field); }; })(result2[0], result2[4])
            : null;
          if (result3 !== null) {
            var result1 = result3;
          } else {
      ...
      function parse_event_value_expression() {
              ...
              if (result26 !== null) {
                ...
                if (result27 !== null) {
                  ...
                  if (result28 !== null) {
                    ...
                    if (result29 !== null) {
                      var result21 = [result23, result24, result25, result26, result27, result28, result29];
                    } else {
                      var result21 = null;
                      pos = savedPos5;
                    }
        ...
        var result22 = result21 !== null
          ? (function(type) { return {type: type, exists: noop, fields: everything}; })(result21[0])
          : null;
        if (result22 !== null) {
        ...
        if (result20 !== null) {
          ...
          if (result7 !== null) {
            ...
            if (result8 !== null) {
              ...
              if (result9 !== null) {
                ...
                if (result10 !== null) {
                  var result11 = parse_event_alternative_member_expression();
                  if (result11 !== null) {
                    var result12 = [];
                    var savedPos3 = pos;
                    ...
                    if (result16 !== null) {
                      ...
                      if (result17 !== null) {
                        ...
                        if (result18 !== null) {
                          var result19 = parse_event_alternative_member_expression();
                          if (result19 !== null) {
                            var result15 = [result16, result17, result18, result19];
                          } else {
                            var result15 = null;
                            pos = savedPos3;
                          }
                    ...
                    if (result12 !== null) {
                      ...
                      if (result13 !== null) {
                        ...
                        if (result14 !== null) {
                          var result5 = [result7, result8, result9, result10, result11, result12, result13, result14];
                        } else {
                          var result5 = null;
                          pos = savedPos2;
                        }
          ...
          var result6 = result5 !== null
            ? (function(type, head, tail) { return compoundFields(type, head, tail); })(result5[0], result5[4], result5[5])
            : null;
          if (result6 !== null) {
            var result4 = result6;
          } else {
          ...
          if (result4 !== null) {
            ...
            var result3 = result2 !== null
              ? (function(type) { return {type: type, exists: noop, fields: noop}; })(result2)
              : null;
            if (result3 !== null) {
              var result1 = result3;
            } else {
      ...
      function parse_event_alternative_member_expression() {
        var cacheKey = 'event_alternative_member_expression@' + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
        ...
        var savedPos0 = pos;
        var savedPos1 = pos;
        var result3 = parse_event_member_expression();
        if (result3 !== null) {
          var result4 = [];
          var savedPos2 = pos;
          var result6 = parse__();
          if (result6 !== null) {
            ...
            if (result7 !== null) {
              var result8 = parse__();
              if (result8 !== null) {
                var result9 = parse_event_member_expression();
                if (result9 !== null) {
                  var result5 = [result6, result7, result8, result9];
                } else {
                  var result5 = null;
        ...
        var result2 = result1 !== null
          ? (function(head, tail) { return alternativeMember(head, tail); })(result1[0], result1[1])
          : null;
        if (result2 !== null) {
          var result0 = result2;
        } else {
    ...
    var filterEqual = function(o, k, v) { o[k] = v; },
        ...
        filterExists = filter("$exists", true),
    ...
    function filter(op, defaultVal) {
      
      return function(o/*bject*/, k/*ey*/, v/*alue*/) {
        ...
        switch (typeof f) {
          ...
          case "object": f[op] = (v !== undefined) ? v : defaultVal; break;
    ...
    function alternativeMember(head, tail) {
      
    	tail = tail.map(function(t){return t[3]})
      
      var fields = [head.field].concat(tail.map(function(e){return e.field}))
  		  ...
  		  return {
  		    ...
  		    fields: function(o) {      	
  		      ...
  		      head.fields(o);
  		    	...
  		    	tail.forEach(function(e,i){e.fields(o);	})
