...
var server_options = {auto_reconnect: true},
    db_options = {native_parser: true, safe: false};

module.exports = function(options) {
  require("./configuration").options = options;
  var server = {},
      primary = http.createServer(),
      secondary = websprocket.createServer(),
      staticDir = options.static || path.join(__dirname, '../../static'),
  ...
  Object.defineProperty(server, "static", {
    get : function(){ return staticDir; },
  ...
  server.start = function(callback) {
    ...
    db.open(function(error) {
      if (error) {
        ...
        return setTimeout( function(){ self.start(callback) } ,5000);
      };
