module.exports = (function(){
  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_start() {
        ...
        var result2 = result1 !== null
          ? (function(expression) { if (!expression.filter) expression.filter = noop; return expression; })(result1[1])
          : null;
        if (result2 !== null) {
          var result0 = result2;
        } else {
      ...
      function parse_event_primary_expression() {
        ...
        var result12 = parse_event_alternative_member_expression();
        if (result12 !== null) {
          var result0 = result12;
        } else {
          var savedPos2 = pos;
    ...
    function filter(op, defaultVal) {
      ...
      return function assign(o/*bject*/, k/*ey*/, v/*alue*/) {
      
      	if(Array.isArray(k)) {
      
      		o["$or"]=[];
      
      		return k.forEach(function(key,i){o["$or"][i]={}; assign(o["$or"][i], key, v)})
  		  ...
  		  return {
  		    ...
  		    value : function(o) {
  		    	...
  		    	if(typeof v === "undefined") {
  				  	...
  				  	for(var i=0; i<tail.length && typeof v === "undefined"; i++) {
